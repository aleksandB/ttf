package io.aleksb.springjwt.auth.security.services;

import io.aleksb.springjwt.auth.exception.TokenRefreshException;
import io.aleksb.springjwt.auth.models.RefreshToken;
import io.aleksb.springjwt.auth.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    @Value("${aleksb.app.jwtRefreshExpirationMs}")
